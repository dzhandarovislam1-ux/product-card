...
const changeColorCardButton = document.querySelector("#change__color__card__button",);
...
const CnangeColorFirstCardButton = document.querySelector('#cnange__color__first__card__button')
